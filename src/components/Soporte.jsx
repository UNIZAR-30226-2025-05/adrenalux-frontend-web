...
const Soporte = () => {
  ...
  const sectionBoxStyle =
    "bg-gray-800/20 border border-white/10 rounded-2xl p-6 shadow-lg backdrop-blur";
        ...
        <section className="space-y-8">
          ...
          <div className={sectionBoxStyle}>
            ...
            <p className="text-gray-300">
              Para consultas generales o problemas técnicos, puedes enviarnos un
              correo electrónico a:{" "}
              <a href="mailto:support@adrenalux.com" className="text-blue-400">
                adrenaluxx@gmail.com
              </a>
              .
            </p>
          </div>
          ...
          <div className={sectionBoxStyle}>
            ...
            <p className="text-gray-300">
              Si tienes algún problema relacionado con el acceso a tu cuenta o
              con funciones premium, no dudes en llamarnos para que podamos
              solucionarlo lo antes posible. Nuestro número de atención es{" "}
              <span className="text-blue-400">+34 912 34 56 78</span>, y estamos
              disponibles para ayudarte en todo lo que necesites.
            </p>
          </div>
        </section>
